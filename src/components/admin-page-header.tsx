...
export function AdminPageHeader({
  ...
  return (
    <div className="relative z-20 flex w-full max-w-full flex-none shrink-0 flex-col gap-2 overflow-visible rounded-xl border border-white/10 bg-gradient-to-br from-[#0F172A] to-[#1e293b]/95 backdrop-blur-xl p-4 shadow-2xl max-md:rounded-none max-md:border-x-0 max-md:border-t-0 max-md:p-3 sm:mb-0 sm:border-0 sm:border-b sm:p-6 md:p-8 lg:px-12">
